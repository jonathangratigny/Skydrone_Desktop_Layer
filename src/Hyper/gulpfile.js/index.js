...
function watchFiles() {
    ...
    gulp.watch(srcPath + "**", gulp.series('copyPhp', reloadBrowserSync));
...
// default
gulp.task('default', gulp.series('copyAssets', 'copyHtml', 'copyPhp', 'copyImages', 'copyFonts', 'compileSaas', 'compileJs', 'watch'), function (done) { done(); });
